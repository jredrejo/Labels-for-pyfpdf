...
'Just choose an option in the menu above': 'Tan sólo elige una opción en el menú superior',
'Labels': 'Etiquetas',
'Labels in the pyfpdf World': 'Labels in the pyfpdf World',
...
'Ticket': 'Tiquete',
'Timestamp': 'Timestamp',
'Try labels in the pyfpdf World': 'Try labels in the pyfpdf World',
'Twitter': 'Twitter',
